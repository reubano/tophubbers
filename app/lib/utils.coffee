...
Minilog
	.enable()
	.pipe new Minilog.backends.jQuery {url: config.api_logs, interval: 1000}
...
found on host #{host}"
	...
	# them out in intervals obj
	# the object the methods are read from and written to methods
